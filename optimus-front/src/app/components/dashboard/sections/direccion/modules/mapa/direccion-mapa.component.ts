...
@Component({
  ...
  template: `
    <div class="modulo-vacio fade-in">
      ...
      <p>Este módulo está en construcción. Próximamente vas a poder visualizar la ubicación geográfica de abonados, dispositivos y técnicos en campo.</p>
    </div>
  `,
  styles: [`
    :host {
...
export class DireccionMapaComponent {}
